...
echo.
echo ========================================
echo RELEASE DestriChiffrage v1.7.8
echo ========================================
echo.
...
if not exist "installer_output\DestriChiffrage-Setup-1.7.8.exe" (
    echo ERREUR: Installateur non cree!
    pause
    exit /b 1
)
echo OK: installer_output\DestriChiffrage-Setup-1.7.8.exe cree
echo.
echo ========================================
echo BUILD TERMINE AVEC SUCCES
echo ========================================
dir dist\DestriChiffrage.exe
dir installer_output\DestriChiffrage-Setup-1.7.8.exe
echo.
pause
